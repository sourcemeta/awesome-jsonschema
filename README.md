...
- (2022) [JSON Schema In Production - You Can Use It Today - Ben Hutton, Postman](https://www.youtube.com/watch?v=48QgjmwLWh0?utm_source=awesome-jsonschema) - Gear the about the journey of organizations that use JSON Schema in production today, and learn about how JSON Schema continues to deliver value..
